	...
	public void run() {
		...
		while (b == true)
		{
			...
			try
			{
				...
				dos.writeUTF("Hello World 2");
				//15. Close the client server
				s.close();
			} catch(SocketTimeoutException e) { System.out.println("timeout"); b = false;}
			catch(IOException e) { System.out.println("io exception"); b = false;}
